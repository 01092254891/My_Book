...
class Drabat extends StatelessWidget {
  Drabat({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.purple,
        title: Text(style: TextStyle(fontSize: 20,fontWeight:FontWeight.bold), "ضربات لا ترحم"),
        actions: [
          IconButton(
              onPressed: () {
